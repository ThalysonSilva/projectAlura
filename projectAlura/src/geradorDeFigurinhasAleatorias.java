...
public class geradorDeFigurinhasAleatorias {
    ...
    public void criar() throws Exception {
        ...
        /*
        Aqui chama uma imagem que ta na maquina local, e na pasta do projeto
        ...
        */
        ...
        // copiar a imagem original para novo imagem(em memória e ára escrever algo)
        ...
        ImageIO.write(imagemOriginal, "png", new File("saida/wukong.jpg")); // criação da figurinha, e o endereço onde ela vai ser criada

    }

    public static void main(String[] args) throws Exception {
        var geradora = new geradorDeFigurinhasAleatorias();
        geradora.criar();
